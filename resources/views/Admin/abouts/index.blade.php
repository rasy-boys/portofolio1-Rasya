...
<head>
    ...
    <title>Admin Asya - Abouts List</title>
    <!-- Custom fonts & styles -->
...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.certificates.index') }}"><i class="fas fa-fw fa-certificate"></i><span>Certificates</span></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Abouts List</h1>
                        <a href="{{ route('admin.abouts.create') }}" class="btn btn-primary">Create New About</a>
                    </div>
                                        ...
                                        @foreach($abouts as $about)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.abouts.destroy', $about->id) }}" class="btn btn-danger btn-sm" data-confirm-delete="true">Delete</a>
                                                        @csrf
                                                        @method('DELETE')
